...
function SvgTemplate({ title, ...rest }: Props) {
  const props = {
    ...rest,
    width: 24,
    height: 24,
  ...
  const titleId = title ? 'SvgTemplate' + '-title' : undefined;
  return (
    <svg
...
const MemoSvgTemplate = React.memo(SvgTemplate);
export default MemoSvgTemplate;
